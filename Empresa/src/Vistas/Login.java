...
public class Login extends javax.swing.JFrame {
    //creación de la variable login de tipo Login
    private static Login login;
    //hace el llamado del método DAOLogin en la variable cLogin
    private DAOLogin cLogin=ControladorLogin.getControladorLogin();
    
    /**
     * Creates new form Login
     */
    //método donde se inicializan los componentes de la clase Login 
    private Login() {
        initComponents();
    }
    //es el método que permite que no se pierda los datos   
    public static Login getLogin(){
        //si login está vacío o es nula entonces se agregue al método Login para que no se pierdan datos y se guarda en la variable login.
        if(login==null)
            //retorna el login
            login=new Login();
    ...
    private void initComponents() {
     ...
     //Quitar texto del usuario.
    private void usuarioMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_usuarioMouseClicked
    usuario.setText("");
    }//GEN-LAST:event_usuarioMouseClicked
   
     //Quitar texto de la contraseña.
    private void contraseniaMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_contraseniaMouseClicked
     ...
     /**
     * cambiar color al pasar el puntero por el boton.
     */
    ...
    // decir si el usuario y contraseña es correcto al inicar la sesion de lo contrario mostrar error.
